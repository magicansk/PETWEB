...
<HEAD>
    ...
    <TITLE>培茲PETS-網站會員系統</TITLE>
    <link rel=stylesheet type="text/css" href="css/rwd.css">
    <link rel=stylesheet type="text/css" href="css/common.css">
    <link rel=stylesheet type="text/css" href="css/member_admin.css">
...
<div class="nav2 media-m-hid media-l-center">
    <div class="location media-xl-10">
        <ul class="breadcrumb">
            ...
            <li><span>網站會員管理</span></li>
        </ul>
    </div>
</div>
<div class="m-adm">
    <div class="m-admbox"><label>管理會員系統</label></div>
    ...
    <div class="m-admbox"><label>
            <a href="member_adminupdate.php?id=<?php echo $row_RecMember["m_id"]; ?>">修改資料</a> |
...
<div class="m-adm">
    <div class="m-adm-list">
        <table class="m-adm-list">
            ...
            <?php while ($row_RecMemberData = $RecMemberData->fetch_assoc()) { ?>
                <tr>
                    <td class="m-adm-list">
                        <p><?php echo $row_RecMemberData["m_name"]; ?></p>
                    </td>
                    <td class="m-adm-list">
                        <p><?php echo $row_RecMemberData["m_username"]; ?></p>
                    </td>
                    <td class="m-adm-list">
                        <p><?php echo $row_RecMemberData["m_jointime"]; ?></p>
                    </td>
                    <td class="m-adm-list">
                        <p><?php echo $row_RecMemberData["m_logintime"]; ?></p>
                    </td>
                    <td class="m-adm-list">
                        <p><?php echo $row_RecMemberData["m_login"]; ?></p>
                    </td>
                    <td class="m-adm-list">
                        <p>
                            <a href="member_adminupdate.php?id=<?php echo $row_RecMemberData["m_id"]; ?>">修改</a><br>
                            <a href="?action=delete&id=<?php echo $row_RecMemberData["m_id"]; ?>" onClick="return deletesure();">刪除</a>
                        </p>
                    </td>
                </tr>
            <?php } ?>
