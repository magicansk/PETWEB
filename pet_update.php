...
<HEAD>
    ...
    <link rel=stylesheet type="text/css" href="css/pet_update.css">
...
<div>
    <div class="m-adm">
        <div class="m-admbox"><label>修改毛孩資料</label></div>
...
<div class="content">
    <div class="petupdate media-m-12 media-l-10 media-xl-10">
        <form action="crop_petupdate.php" method="POST" enctype="multipart/form-data" name="formJoin" id="formJoin" onSubmit="return checkForm();">
            <table>
                ...
                <?php if (isset($row_RecPhoto[0][4])) { ?>
                    ...
                    <tr>
                        <td>
                            <label id="cover" class="upload_cover"><span>更換照片</span>
                ...
                <?php if (isset($row_RecPhoto[1][4])) { ?>
                    ...
                    <tr>
                        <td>
                            <label id="cover1" class="upload_cover"><span>更換照片</span>
                ...
                <?php if (isset($row_RecPhoto[2][4])) { ?>
                    ...
                    <tr>
                        <td>
                            <label id="cover2" class="upload_cover"><span>更換照片</span>
                ...
                <?php if (isset($row_RecPhoto[3][4])) { ?>
                    ...
                    <tr>
                        <td>
                            <label id="cover3" class="upload_cover"><span>更換照片</span>
                ...
                <tr>
                    <td><textarea placeholder="自我介紹" name="p_introduction" id="p_introduction"><?php echo $row_RecPet["p_introduction"]; ?></textarea></td>
                </tr>
