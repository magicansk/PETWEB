...
CREATE DATABASE if not exists `petweb` CHARACTER SET utf8 COLLATE utf8_unicode_ci; USE `petweb`;
...
(25, '系統管理員', 'admin', '$2y$10$/P9G24rH10WjZm0NPYcXgO2yuGqEGKNjHDGrTyuNTKUNet5DGDgIS', '男', '2019-11-29', 'admin', 'admin001@adm.com', NULL, '0912345678', '喵星球', 49, '2019-12-24 11:01:26', '2019-11-29 20:55:27'),
...
(28, '金太妍', 'user0003', '$2y$10$S6JwyaW6O4WSsMwiKHPnoe1F16WOkNWNMZnvGXzFcFl31G/.7./we', '男', '2019-12-30', 'member', 'user0003@user0003.com', NULL, '0980354749', '外太空', 33, '2019-12-24 14:47:41', '2019-12-13 15:31:17'),
...
(273, 'ORANGE', '貓咪', '米克斯', '女生', 3, '嗨~我是橘子唷!!!', 28);
...
(597, 273, '2019-12-24 14:42:00', '', '273user0001-1.jpeg'),
(598, 273, '2019-12-24 14:42:00', '', '273user0001-2.jpeg'),
(599, 273, '2019-12-24 14:42:00', '', '273user0001-3.jpeg');
...
--
ALTER TABLE `petdata`
  MODIFY `p_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=275;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `petphoto`
--
ALTER TABLE `petphoto`
  MODIFY `pp_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=603;
